...
class LeadDiscoveryEngine:
    ...
    async def _discover_cdsco_indian_facilities(self, region: str, sector: str, limit: int = 10, exclude_domains: set = None) -> List[Dict[str, Any]]:
        ...
        indian_producers = [
            ...
            {"name": "Eris Lifesciences FDF", "domain": "eris.co.in", "region": "Ahmedabad, Gujarat, India", "industry_subsector": "Pharmaceutical Formulations & Finished Dosage (FDF)", "employee_range": "400-800", "website_url": "https://eris.co.in"},
            ...
            {"name": "Alkem Laboratories Formulations", "domain": "alkemlabs.com", "region": "Mumbai, Maharashtra, India", "industry_subsector": "Pharmaceutical Formulations & Finished Dosage (FDF)", "employee_range": "500+", "website_url": "https://alkemlabs.com"},
            {"name": "Macleods Pharmaceuticals FDF", "domain": "macleodspharma.com", "region": "Mumbai, Maharashtra, India", "industry_subsector": "Pharmaceutical Formulations & Finished Dosage (FDF)", "employee_range": "500+", "website_url": "https://macleodspharma.com"},
            ...
            {"name": "Indoco Remedies Formulations", "domain": "indoco.com", "region": "Mumbai, Maharashtra, India", "industry_subsector": "Pharmaceutical Formulations & Finished Dosage (FDF)", "employee_range": "400-800", "website_url": "https://indoco.com"},
            ...
            {"name": "Cadila Pharmaceuticals FDF", "domain": "cadilapharma.com", "region": "Ahmedabad, Gujarat, India", "industry_subsector": "Pharmaceutical Formulations & Finished Dosage (FDF)", "employee_range": "500+", "website_url": "https://cadilapharma.com"},
